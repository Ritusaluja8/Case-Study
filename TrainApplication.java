...
public class TrainApplication {
	...
	public static void main(String[] args)throws ClassNotFoundException, SQLException, IOException, NullPointerException {
        ...
        System.out.println("Enter Travel Date: day/month/year: ");
        ...
        Ticket myTicket = new Ticket(day,year,month,myTrain);
